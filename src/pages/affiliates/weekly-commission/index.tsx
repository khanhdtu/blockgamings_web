...
export const CommissionAffiliates = (): JSX.Element => {
  ...
  useEffect(() => {
    affiliates.doFetchCommission()
    affiliates.doCloseLoading()
    affiliates.doSetAffiliateType('COMMISSION')
  }, [])
  ...
  return (
    <Layout type='default'>
      ...
      <Box display='flex' mt={2} mb={2}>
        ...
        <Box ml={1}>
          <Search onSearch={affiliates.doFetchCommission} onReset={affiliates.doFetchCommission} isLoading={affiliates.isLoading} />
        </Box>
      </Box>
      <Table
        data={affiliates.commissionList}
        omit={['casinoPv', 'casinoPgv', 'casinoLevel']}
...
export default observer(CommissionAffiliates)
